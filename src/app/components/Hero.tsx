      ...
      <div
        ...
        <div className="flex flex-col md:flex-row  bg-black bg-opacity-50 text-center justify-center items-center h-full text-white  ">
          <div className="md:w-1/2 p-4">
            <h1 className="text-4xl md:text-5xl   font-bold "> Welcome to Crime Blog</h1>
            <p className="text-lg md:text-xl mb-8 pt-3">Discover crime scene & crimanals 
              
              
              
              
              and stay updated with our <br /> latest posts unique blog that leaves a lasting impression..</p>
            <Link
